...
<%@ taglib prefix = "tools"  uri="/tlds/tools.tld" %>
	...
	<div class="contents">
		<div class="contents_wrapper">
			...
			<table border=1>
				<tr>
					<td width=40>순번</td>
					<td width=20>${Read.seqNo}</td>
					<td width=40>제목</td>
					<td width=100>${Read.title}</td>
					<td width=50>작성자</td>
					<td width=30>${Read.writer}</td>
					<td width=70>작성일자</td>
					<td>${Read.wdate}</td>
					<td width=70>작성시각</td>
					<td>${Read.wtime}</td>
				...
				<tr>
					...
					<td width=350 height="300" colspan="10">
				
					${Read.content} <tools:LineTag/></td>
